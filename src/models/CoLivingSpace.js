...
const CoLivingSpaceSchema = new Schema({
...
CoLivingSpaceSchema.virtual('space_type').get(function () {
    return "co-living";
});
CoLivingSpaceSchema.index({ geometry: "2dsphere" });
CoLivingSpaceSchema.index({ "name": 1, "location.address": 1 }, { unique: true })


export default CoLivingSpaceSchema;