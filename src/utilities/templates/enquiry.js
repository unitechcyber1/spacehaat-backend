                    ...
                    <div class="block-grid"
                        ...
                        <div
                            ...
                            <div class="col num12"
                                ...
                                <div style="width:100% !important;">
                                    <div
                                        style="font-size: 12px; line-height: 16px; text-align:center;border:1px solid #ebebeb;padding:20px 30px;border-bottom:none;">
                                    </div>
                                    <div
                                    ...
                                    <div class="onboard-img-box"
                                        ...
                                        <p
                                           ...
                                           Thank you for reaching out to us regarding your office space requirements.
                                           <br />Our team will assist you with the best options.
                                        </p>
                                        <p
                                            style="font-size:14px;font-weight:400;letter-spacing:0.2px;color:#212121;margin:20px 0;line-height:20px;">
                                            If you need immediate support, feel free to contact us :<br />
                                            M: <a href="tel:+919355289999"
                                                style="color:#4343e8;text-decoration:none;font-weight:bold;">+91
                                                9355 28 9999</a><br /> E: <a href="mailto:hello@cofynd.com"
                                                style="color:#4343e8;text-decoration:none;font-weight:bold;">hello@cofynd.com</a>
                                        </p>
                                        <p
                                            style="font-size:14px;font-weight:400;letter-spacing:0.2px;color:#212121;margin:10px 0 5px;line-height:20px;">
                                            We’re here to help you find the perfect Office Space for you !
                                        </p>
                                        <p
                                            ...
                                            <!-- ABC<br /> -->
                                           <a href="https://cofynd.com/"
                                                style="color:#4343e8;text-decoration:none;font-weight:bold;">www.cofynd.com</a>
                                        </p>
                                    </div>
