								...
								<div style="width:100% !important;">
									...
									<div class="onboard-img-box"
										...
										<div class="table-gridbox"
											...
											<div class="list-rowbox"
												...
												<div class="left-column"
													style="width:35%;float:left;padding:8px 15px;font-size:14px;color:#000;">
													Center Url<span class="on-device-item">:</span></div>
												<div class="right-column"
													style="width:65%;float:left;border-left:1px solid #c3c3c3;padding:8px 15px;font-size:14px;color:#000;font-weight:bold;">
													{centerUrl}
													</div>
											...
											<div class="list-rowbox"
												...
												<div class="left-column"
													style="width:35%;float:left;padding:8px 15px;font-size:14px;color:#000;">
													Visitor Detail<span class="on-device-item">:</span></div>
												<div class="right-column"
													style="width:65%;float:left;border-left:1px solid #c3c3c3;padding:8px 15px;font-size:14px;color:#000;line-height:25px;">
													{visitorsDetail}
													<!-- Dilveen Singh Aulakh<br />
													+91 9876543210<br />
													Dilveensinghaulakh@gmail.com -->
												</div>
											</div>
											<div class="list-rowbox" style="width:100%;float:left;">
												<div class="left-column"
													style="width:35%;float:left;padding:8px 15px;font-size:14px;color:#000;">
													Interested In<span class="on-device-item">:</span></div>
												<div class="right-column"
													style="width:65%;float:left;border-left:1px solid #c3c3c3;padding:8px 15px;font-size:14px;color:#000;">
													{interested_in}</div>
											</div>
									...
									<div class="onboard-img-box"
										...
										<p
                                            ...
                                            This is an auto generated mail. Please do not reply directly to this email
										</p>
										<p
