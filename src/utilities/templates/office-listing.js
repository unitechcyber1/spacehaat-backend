                            ...
                            <div class="col num12"
                                ...
                                <div style="width:100% !important;">
                                    ...
                                    <div class="onboard-img-box"
                                        ...
                                        <p style="font-size:14px;font-weight:400;letter-spacing:0.2px;color:#212121;margin:10px 0 5px;line-height:20px;">
                                           <b>Space Details</b><br/><br/>
                                            Name of Building/Workspace: {centerName}<br />
                                            Available Space: {available_space}<br />
                                            Expected Monthly Rent: {expected_monthly_rent}/-per sq. ft.<br />
                                            Amenties: {amenties}<br />
                                            City : {city}<br />
                                            Address: {address}<br />
                                            Added On Date: {date}<br />
                                            Added On Time: {time}
                                        <p style="font-size:14px;font-weight:400;letter-spacing:0.2px;color:#212121;margin:10px 0 5px;line-height:20px;">
                                        ...
                                        <p
                                            style="font-size:14px;font-weight:400;letter-spacing:0.2px;color:#212121;margin:20px 0 12px;line-height:20px;">
                                            Regards,<br />
                                            <!-- ABC<br /> -->
                                            Team CoFynd
                                        </p>
