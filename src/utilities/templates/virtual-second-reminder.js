								...
								<div style="width:100% !important;">
									<div
										...
										<img style="max-width:100%;"
											src="https://img.cofynd.com/images/latest_images_2024/2b595f8f7dbab4bddc301f93f2ce1055051cf545.webp"
											alt="Banner" />
									</div>
									<div class="onboard-img-box"
										...
										<p
											...
											Choosing the right location impacts credibility and bank approvals for your Virtual Office.
										</p>
										<p style="font-size:14px;font-weight:bold;margin:15px 0 10px;color:#000;">Quick facts :</p>
										<ul style="font-size:14px;line-height:22px;color:#212121;margin:0 0 15px;padding-left:20px;">
											<li>Budget-friendly & fast approvals</li>
											<li>Balanced pricing & corporate image</li>
											<li>IT-focused hub</li>
											<li>Premium brand positioning</li>
										</ul>
										<p
											style="font-size:14px;font-weight:400;letter-spacing:0.2px;color:#212121;margin:15px 0 12px;line-height:20px;">
											If you tell us your business type, we'll suggest the most strategic option.
										</p>
