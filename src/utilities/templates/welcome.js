					...
					<div class="block-grid"
						...
						<div
							...
							<div class="col num12"
								...
								<div style="width:100% !important;">
									<div
										style="font-size: 12px; line-height: 16px; text-align:center;border:1px solid #ebebeb;padding:0px 30px;border-bottom:none;">
									</div>
									<div
										...
										<img style="max-width:100%;"
											src="https://ci6.googleusercontent.com/proxy/G9HkmByacjBIXyeUEgSvHbISy_WbTG6nb9LkER6aAIkJxrGueoKgQgYNUUsQpM4mMNdU3m4fPkd-kzHXgkIHdZw7p1jtIXLJfl7gpdaqT_i2uZlO84VIOc2r3hf9ifA=s0-d-e1-ft#https://cofynd-staging.s3.ap-south-1.amazonaws.com/mailer/welcome-banner.png"
											alt="Banner" />
									</div>
									<div class="onboard-img-box"
										style="margin-bottom:0;border:1px solid #ebebeb;border-top:none;padding: 0 50px 5px;border-radius: 0;border-bottom:none;">
										<p
										...
										<p
											...
											Thank you for joining the Cofynd family<br />
											and completing your listing on our platform! 🚀</p>
										<p
											style="font-size:14px;font-weight:400;letter-spacing:0.2px;color:#212121;margin:15px 0 12px;line-height:20px;">
											Your space will soon be visible to 1 lac + users searching for coworking and coliving options. We’re excited to help you connect with your next great tenant.
										</p>
										<p
											style="font-size:14px;font-weight:400;letter-spacing:0.2px;color:#212121;margin:15px 0 12px;line-height:20px;">
											<a href="https://listing.cofynd.com/"
												style="color:#4343e8;text-decoration:none;font-weight:bold;">👉 Log in to Your Account</a>
										</p>
									</div>
									<div class="onboard-img-box device-top"
										...
										<p class="space-device0"
											...
											If you need any assistance, <br /> feel free to contact us on 
											<a href="tel:+919355289999"
												style="color:#027fff;text-decoration:none;font-weight:bold;">+91
												9355 28 9999</a>
											or email us on  <a href="mailto:hello@cofynd.com"
												style="color:#027fff;text-decoration:none;font-weight:bold;">hello@cofynd.com</a></p>
										<p
											style="font-size:14px;font-weight:400;letter-spacing:0.2px;color:#212121;margin:15px 0 12px;line-height:20px;">
										</p>
										<p
