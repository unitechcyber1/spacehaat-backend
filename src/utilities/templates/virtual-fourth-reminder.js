								...
								<div style="width:100% !important;">
									...
									<div class="onboard-img-box"
										...
										<p
											...
											Just checking in — should we keep your <strong>{city}</strong> Virtual Office option active for you, or would you like to revisit later?
										</p>
										<p
											style="font-size:14px;font-weight:400;letter-spacing:0.2px;color:#212121;margin:15px 0 12px;line-height:20px;">
											If timing is not right, no worries at all.
										</p>
										<p
											style="font-size:14px;font-weight:400;letter-spacing:0.2px;color:#212121;margin:15px 0 12px;line-height:20px;">
