								...
								<div style="width:100% !important;">
									<div
										...
										<img style="max-width:100%;"
											src="https://img.cofynd.com/images/latest_images_2024/2b2872f189f92e25bdad8c7305ff09ece6dfe65b.webp"
											alt="Banner" />
									</div>
									<div class="onboard-img-box"
										style="margin-bottom:0;border:1px solid #ebebeb;border-top:none;padding:30px;border-radius: 0;border-bottom:none;">
										<p class="name-tag"
										...
										<p
											style="font-size:14px;font-weight:400;letter-spacing:0.2px;color:#212121;margin:15px 0 12px;line-height:20px;">
											It's been a few days since you enquired about a Virtual Office with CoFynd, so I just wanted to check if you need any assistance moving forward.
										</p>
										<p
											style="font-size:14px;font-weight:400;letter-spacing:0.2px;color:#212121;margin:15px 0 12px;line-height:20px;">
											If you're planning to proceed, I can help with:
										</p>
										<ul style="font-size:14px;line-height:22px;color:#212121;margin:0 0 15px;padding-left:20px;">
											<li>Clarifying documentation required for GST or company registration</li>
											<li>Sharing updated pricing and inclusions</li>
											<li>Recommending suitable locations based on your business needs</li>
											<li>Reserving a slot while you complete internal approvals</li>
										</ul>
										<p
											style="font-size:14px;font-weight:400;letter-spacing:0.2px;color:#212121;margin:15px 0 12px;line-height:20px;">
											If your plans have changed or you need more time, that's absolutely fine — just let me know how you'd like to proceed.
										</p>
										<p
											style="font-size:14px;font-weight:400;letter-spacing:0.2px;color:#212121;margin:15px 0 12px;line-height:20px;">
										...
										<p style="font-size:14px;margin-top:20px;color:#212121;">
											<strong>Vikash Agrawa</strong><br>
