								...
								<div style="width:100% !important;">
									...
									<div class="onboard-img-box"
										...
										<p
											...
											Many businesses face GST or bank rejection because their Virtual Office documentation isn't structured properly.
										</p>
										<p
											style="font-size:14px;font-weight:400;letter-spacing:0.2px;color:#212121;margin:15px 0 12px;line-height:20px;">
											Before you finalize any provider, ensure they provide:
										</p>
										<ul style="font-size:14px;line-height:22px;color:#212121;margin:0 0 15px;padding-left:20px;">
											<li>Registered/Notarised Agreement</li>
											<li>Valid NOC</li>
											<li>Latest Utility Bills</li>
											<li>Support in case of verification</li>
										</ul>
										<p
											style="font-size:14px;font-weight:400;letter-spacing:0.2px;color:#212121;margin:15px 0 12px;line-height:20px;">
											At Cofynd, we ensure documentation is fully compliant and submission-ready.
										</p>
										<p
											style="font-size:14px;font-weight:400;letter-spacing:0.2px;color:#212121;margin:15px 0 12px;line-height:20px;">
											Call us now to secure your Virtual Office in <strong>{city}</strong>
										</p>
