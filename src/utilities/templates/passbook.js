					...
					<div class="block-grid"
						...
						<div
							...
							<div class="col num12"
								...
								<div style="width:100% !important;">
									<div
										style="font-size: 12px; line-height: 16px; text-align:center;border:1px solid #ebebeb;padding:40px 30px;border-bottom:none;">
										<a href="#"><img style="width:156px;height:39px;max-width:156px"
												src="https://ci4.googleusercontent.com/proxy/aqNL-KH2LOlKk_ouTtTGFryw143SNU_QDGnhhyLRPCpRObJnqxjRXg2qTSJ-SrMAhAorVqdmhV5u7inNyqd3KGee0a7tbIVvSSWtBIzf8hC9dG1VMQ=s0-d-e1-ft#https://cofynd-staging.s3.ap-south-1.amazonaws.com/mailer/logo.png"
												alt="Logo" /></a>
									</div>
									<div
										style="font-size: 12px; line-height: 16px; text-align:center;border:1px solid #ebebeb;padding:0;border-bottom:none;border-top:none;height:20px;">
									</div>
									<div class="onboard-img-box"
										style="margin-bottom:0;border:1px solid #ebebeb;border-top:none;padding: 0 50px 30px;border-radius: 0;border-bottom:none;">


										<p class="device-font"
											style="font-size:30px;font-weight:400;letter-spacing:0;color:#000;margin:0 0 15px;line-height:25px">
											<b>{category} Booking Confirmed!</b></p>
										<p style="display:block;height:3px;margin:10px 0;"></p>
										<p
											style="display:inline-block;margin:0;height:2px;background-color:#8C8CED;width:65px;">
										</p>
										<p style="display:block;height:5px;margin:15px 0;"></p>
										<p
											style="font-size:22px;font-weight:400;letter-spacing:0;color:#000;margin:0 0 15px;line-height:25px">
											<b>Hey {name}</b>,</p>
										<p
											style="font-size:14px;font-weight:400;letter-spacing:0.2px;color:#212121;margin:15px 0 5px;line-height:20px;">
											Thank you for choosing CoFynd to book your <b>{category}</b> for <b>{centerName}</b>.
										</p>

										<p
											style="font-size:14px;font-weight:400;letter-spacing:0.2px;color:#212121;margin:10px 0 5px;line-height:20px;">
											We are pleased to confirm your booking as below :</p>

									</div>
									<div class="onboard-img-box"
										style="margin-bottom:0;border:1px solid #ebebeb;border-top:none;padding: 0 50px 30px;border-radius: 0;border-bottom:none;">
										<div class="table-gridbox"
											style="width:100%;display:inline-block;border:1px solid #c3c3c3;">
											<div class="list-rowbox"
												style="width:100%;float:left;border-bottom:1px solid #c3c3c3;">
												<div class="left-column"
													style="width:35%;float:left;padding:8px 15px;font-size:14px;color:#000;">
												 Booking ID<span class="on-device-item">:</span></div>
												<div class="right-column"
													style="width:65%;float:left;border-left:1px solid #c3c3c3;padding:8px 15px;font-size:14px;color:#000;font-weight:bold;">
													{bookingId}
													</div>
											</div>
											<div class="list-rowbox"
												...
												<div class="left-column"
													style="width:35%;float:left;padding:8px 15px;font-size:14px;color:#000;">
													Center Name<span class="on-device-item">:</span></div>
												<div class="right-column"
													style="width:65%;float:left;border-left:1px solid #c3c3c3;padding:8px 15px;font-size:14px;color:#000;font-weight:bold;">
													{centerName}
													</div>
												...
												<div class="left-column"
													style="width:35%;float:left;padding:8px 15px;font-size:14px;color:#000;">
													Location<span class="on-device-item">:</span></div>
												<div class="right-column"
													style="width:65%;float:left;border-left:1px solid #c3c3c3;padding:8px 15px;font-size:14px;color:#000;font-weight:bold;">
													{location}
													</div>
											...
											<div class="list-rowbox"
												...
												<div class="left-column"
													style="width:35%;float:left;padding:8px 15px;font-size:14px;color:#000;">
													Date and Time<span class="on-device-item">:</span></div>
												<div class="right-column"
													style="width:65%;float:left;border-left:1px solid #c3c3c3;padding:8px 15px;font-size:14px;color:#000;font-weight:bold;">
													{date} | {time}</div>
											</div>
											<div class="list-rowbox"
												...
												<div class="left-column"
													style="width:35%;float:left;padding:8px 15px;font-size:14px;color:#000;">
													Number of Visitors<span class="on-device-item">:</span></div>
												<div class="right-column"
													style="width:65%;float:left;border-left:1px solid #c3c3c3;padding:8px 15px;font-size:14px;color:#000;">
													{visitors}</div>
											</div>
											<div class="list-rowbox"
												style="width:100%;float:left;border-bottom:1px solid #c3c3c3;">
												<div class="left-column"
													style="width:35%;float:left;padding:8px 15px;font-size:14px;color:#000;">
													Booking Date<span class="on-device-item">:</span></div>
												<div class="right-column"
													style="width:65%;float:left;border-left:1px solid #c3c3c3;padding:8px 15px;font-size:14px;color:#000;font-weight:bold;">
													{bookingDates}
													</div>
											...
											<div class="list-rowbox"
												...
												<div class="left-column"
													style="width:35%;float:left;padding:8px 15px;font-size:14px;color:#000;">
													Office Timing<span class="on-device-item">:</span></div>
												<div class="right-column"
													style="width:65%;float:left;border-left:1px solid #c3c3c3;padding:8px 15px;font-size:14px;color:#000;">
													{opentiming} to {closetiming}</div>
											</div>
												<div class="list-rowbox"
												style="width:100%;float:left;border-bottom:1px solid #c3c3c3;">
												<div class="left-column"
													style="width:35%;float:left;padding:8px 15px;font-size:14px;color:#000;">
													Amount Paid<span class="on-device-item">:</span></div>
												<div class="right-column"
													style="width:65%;float:left;border-left:1px solid #c3c3c3;padding:8px 15px;font-size:14px;color:#000;">
													₹ {amount}</div>
											</div>
											<div class="list-rowbox" style="width:100%;float:left;">
												<div class="left-column"
													style="width:35%;float:left;padding:8px 15px;font-size:14px;color:#000;">
													Payment Mode<span class="on-device-item">:</span></div>
												<div class="right-column"
													style="width:65%;float:left;border-left:1px solid #c3c3c3;padding:8px 15px;font-size:14px;color:#000;">
													{paymentMode}</div>
											</div>
									...
									<div class="onboard-img-box"
										...
										<p
											...
											Please get in touch with us on <a href="mailto:hello@cofynd.com"
												style="color:#4343e8;text-decoration:none;font-weight:bold;">hello@cofynd.com</a>
